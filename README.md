...
Four branches are in this repository: `main`, `TeX`, `LyX` and `MS-WORD`. Make sure to checkout to the desired branch if you want download your preferable template.
